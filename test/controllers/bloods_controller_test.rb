...
class BloodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blood" do
    assert_difference('Blood.count') do
      post bloods_url, params: { blood: { maxblood: @blood.maxblood, minblood: @blood.minblood } }
    end
  ...
  test "should update blood" do
    patch blood_url(@blood), params: { blood: { maxblood: @blood.maxblood, minblood: @blood.minblood } }
